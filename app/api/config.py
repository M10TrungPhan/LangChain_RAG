...
LLM_CHUNK_SIZE = int(os.getenv("LLM_CHUNK_SIZE", 256))
...
MAX_TOKEN_EMBEDDINGS = int(os.getenv("MAX_TOKEN_EMBEDDINGS", 1024))
...
VECTOR_EMBEDDINGS_DIM = int(os.getenv('VECTOR_EMBEDDINGS_DIM',1024))
